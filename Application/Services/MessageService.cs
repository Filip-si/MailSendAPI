...
//    public async Task<IEnumerable<Template>> GetMessages()
//    {
//      return await _context.Messages.AsNoTracking()
//        .ToListAsync();
//    }

//    public async Task<List<Template>> SaveMessagesAsync(IEnumerable<string> recepients, Guid templateId)
//    {
//      await using var transaction = await _context.Database.BeginTransactionAsync();
//      try
//      {
//        List<Template> messages = new();
//        foreach (var recepient in recepients)
//        {
//          Template message = new(_configuration["EmailConfigurations:From"], recepient, templateId, DateTime.Now);
...
//    {
//      Template message = new(_configuration["EmailConfigurations:From"], recepients, templateId, DateTime.Now);
